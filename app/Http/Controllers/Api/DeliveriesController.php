...
class DeliveriesController extends Controller
{
    ...
    {
        $data = DeliveriesItem::groupBy('description')->selectRaw('sum(quantity) as total_quantity, `price`, `item_cost`')->where('created_at', '>=', Carbon::now()->startOfMonth())->with('Item')->get();
        return response($data);
    }
}
