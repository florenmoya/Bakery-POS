...
class DeliveriesController extends Controller
{
    ...
    {
        $data = DeliveriesItem::groupBy('item_id, item_id, price')->selectRaw('sum(quantity) as total_quantity, `item_cost`,`item_id`,`price')->where('created_at', '>=', Carbon::now()->startOfMonth())->with('Item')->get();
        return response($data);
    }
}
